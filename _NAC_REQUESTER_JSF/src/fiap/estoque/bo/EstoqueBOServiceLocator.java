...
public class EstoqueBOServiceLocator extends org.apache.axis.client.Service implements fiap.estoque.bo.EstoqueBOService {
    ...
    private java.lang.String EstoqueBO_address = "http://localhost:8080/_NAC20_PWAI_WEBSERVICE/services/EstoqueBO";
    ...
    public fiap.estoque.bo.EstoqueBO getEstoqueBO(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            fiap.estoque.bo.EstoqueBOSoapBindingStub _stub = new fiap.estoque.bo.EstoqueBOSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (fiap.estoque.bo.EstoqueBO.class.isAssignableFrom(serviceEndpointInterface)) {
                fiap.estoque.bo.EstoqueBOSoapBindingStub _stub = new fiap.estoque.bo.EstoqueBOSoapBindingStub(new java.net.URL(EstoqueBO_address), this);
                _stub.setPortName(getEstoqueBOWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://bo.estoque.fiap", "EstoqueBOService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://bo.estoque.fiap", "EstoqueBO"));
        }
